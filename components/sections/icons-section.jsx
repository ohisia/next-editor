    ...
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      >
        <Button
          ...
          icon={<img src="https://raw.githubusercontent.com/polotno-project/polotno-studio/5d5c4dd669211dbeecd5edff7aae232ca3c83c81/public/iconfinder.svg" alt="IconFinder" width="15" style={{ filter: 'brightness(0%)' }}/>}
        >
          IconFinder
        </Button>
        <Button
          ...
          icon={<img src="https://raw.githubusercontent.com/polotno-project/polotno-studio/5d5c4dd669211dbeecd5edff7aae232ca3c83c81/public/noun-project.svg" alt="IconFinder" width="15" style={{ filter: 'brightness(0%)' }}/>}
        >
          Noun Project
        </Button>
        <Button
          ...
          icon={
            <img
              src="https://github.com/polotno-project/polotno-studio/blob/master/public/flaticon.png?raw=true"
              alt="FlatIcon"
              width="15"
...
export const IconsSection = {
  ...
  Tab: (props) => (
    <SectionTab name="Icons" {...props}>
      <FaVectorSquare style={{ marginInline: 'auto' }} />
    </SectionTab>
  ),
